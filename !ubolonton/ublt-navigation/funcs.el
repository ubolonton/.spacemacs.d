...
(defun ublt-navigation/swap-windows ()
...
(defun ublt-navigation/switch-to-last-buffer ()
  (interactive)
...
(if (functionp 'org-open-at-point-global)
    (defalias 'ublt-navigation/browse-url-at-point 'org-open-at-point-global)
  (defun ublt-navigation/browse-url-at-point ()
    (interactive)
    (case major-mode
